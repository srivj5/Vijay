                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?php echo $i;?></td>
                                                <td><?php echo getAttri($attr->attribute);?></td>
                                                <td><?php echo $attr->attribute ;?></td> 
                                                <td><?php echo $attr->attribute_value ;?></td> 

                                                <td><?php echo ($attr->status == 1)?"Enable":"Disable" ;?></td>
                                                <td><a href="<?php echo admin_url() . 'attribute/add_attribute_value/' . $attr->id ?>" data-placement="top" data-toggle="popover" data-content="Edit" class="poper"><i class="fa fa-pencil text-primary"></i></a> / 
                                                    <?php if($attr->status == 0){?>
                                                    <a href="<?php echo admin_url() . 'attribute/attribute_status_change/' . $attr->id .'/1'?>" data-placement="top" data-toggle="popover" data-content="Status" class="poper"><i class="fa fa-lock text-primary"></i></a><?php } else{ ?> <a href="<?php echo admin_url() . 'attribute/attribute_status_change/' . $attr->id .'/0'?>" data-placement="top" data-toggle="popover" data-content="Status" class="poper"><i class="fa fa-unlock text-primary"></i></a> <?php } ?>
                                                </td>
