                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $reg->contract ;?></td>
                                                <td><?php echo $reg->feature ;?></td>
                                                <td><?php echo $reg->address ;?></td>
                                                <td><?php echo ($reg->email_verification == 1)?"Verified":"Not Verified" ;?></td>
                                                <td><?php echo ($reg->status == 1)?"Enable":"Disable" ;?></td>
                                                <td><a href="<?php echo admin_url() . 'registration/edit_reg/' . $reg->id ?>" data-placement="top" data-toggle="popover" data-content="Edit" class="poper"><i class="fa fa-pencil text-primary"></i></a> / 
                                                    <?php if($reg->approve_status == 0){?>
                                                    <a href="<?php echo admin_url() . 'registration/status_reg/' . $reg->id .'/1'?>" data-placement="top" data-toggle="popover" data-content="Status" class="poper"><i class="fa fa-lock text-primary"></i></a><?php } else{ ?> <a href="<?php echo admin_url() . 'registration/status_reg/' . $reg->id .'/0'?>" data-placement="top" data-toggle="popover" data-content="Status" class="poper"><i class="fa fa-unlock text-primary"></i></a> <?php } ?>
                                                </td>
