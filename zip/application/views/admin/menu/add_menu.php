                                ...
                                ?>
                                    <!-- <form class="form-valide" action="#" method="post"> -->                                        
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control"  id="cat_menu" name="cat_menu" value="<?php echo $menu_rec->cat_menu;?>"  placeholder="Enter a CatMenu Name ">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="menu" name="menu" value="<?php echo $menu_rec->menu;?>" placeholder="Enter a menu">
                                            </div>
                                        </div>
                                        <div class="form-group row">
